      ...
      cachedImage_ftttmlogorings_gif (0)
{
    ...
    groupComponent2->setColour (GroupComponent::textColourId, Colour (0x66812b2b));

    addAndMakeVisible (groupComponent3 = new GroupComponent (L"new group",
                                                             L"Main Controls"));
    groupComponent3->setColour (GroupComponent::outlineColourId, Colour (0x66812b2b));
    groupComponent3->setColour (GroupComponent::textColourId, Colour (0x66812b2b));

    addAndMakeVisible (recordButton = new TextButton (L"record"));
    ...
    addAndMakeVisible (stackButton = new TextButton (L"stack"));
    stackButton->setConnectedEdges (Button::ConnectedOnLeft);
    ...
    addAndMakeVisible (decayKnob = new Slider (L"decayKnob"));
    ...
    addAndMakeVisible (speedKnob = new Slider (L"speedKnob"));
    ...
    addAndMakeVisible (deviceButton = new TextButton (L"devices"));
    deviceButton->setButtonText (L"Audio device...");
  ...
  addAndMakeVisible (loopComp16 = new LoopComponent("V"));
    ...
    groupComponent->setColour (GroupComponent::textColourId, Colour (0x66812b2b));

    addAndMakeVisible (masterKnob = new Slider (L"masterKnob"));
    masterKnob->setRange (0, 10, 0);
    masterKnob->setSliderStyle (Slider::Rotary);
    masterKnob->setTextBoxStyle (Slider::NoTextBox, false, 80, 20);
    masterKnob->setColour (Slider::rotarySliderFillColourId, Colour (0xff6be171));
    masterKnob->addListener (this);

    addAndMakeVisible (label5 = new Label (L"new label",
                                           L"master"));
    label5->setFont (Font (11.0000f, Font::plain));
    label5->setJustificationType (Justification::centredLeft);
    label5->setEditable (false, false, false);
    label5->setColour (Label::textColourId, Colour (0xff6be171));
...
RangLoopComponent::~RangLoopComponent()
{
  ...
  //audioDeviceManager.stopDevice();
    ...
    deleteAndZero (loopComp4);
    deleteAndZero (loopComp5);
    deleteAndZero (loopComp6);
    deleteAndZero (loopComp7);
    deleteAndZero (loopComp8);
    deleteAndZero (loopComp9);
    deleteAndZero (loopComp10);
    deleteAndZero (loopComp11);
    deleteAndZero (loopComp12);
    deleteAndZero (loopComp13);
    deleteAndZero (loopComp14);
    deleteAndZero (loopComp15);
    deleteAndZero (loopComp16);
...
void RangLoopComponent::resized()
{
    ...
    loopComp4->setBounds (176, 80, 50, 50);
    loopComp5->setBounds (8, 136, 50, 50);
    loopComp6->setBounds (64, 136, 50, 50);
    loopComp7->setBounds (120, 136, 50, 50);
    loopComp8->setBounds (176, 136, 50, 50);
    loopComp9->setBounds (8, 192, 50, 50);
    loopComp10->setBounds (64, 192, 50, 50);
    loopComp11->setBounds (120, 192, 50, 50);
    loopComp12->setBounds (176, 192, 50, 50);
    loopComp13->setBounds (8, 248, 50, 50);
    loopComp14->setBounds (64, 248, 50, 50);
...
<JUCER_COMPONENT documentType="Component" className="RangLoopComponent" componentName=""
  ...
  <SLIDER name="new slider" id="600d5c02ae538547" memberName="slider" virtualName=""
          explicitFocusOrder="0" pos="256 232 240 8" thumbcol="ff6be171"
  ...
  <LABEL name="new label" id="efd284515b19c3ca" memberName="label3" virtualName=""
         explicitFocusOrder="0" pos="256 208 39 16" textCol="ff6be171"
  ...
  <JUCERCOMP name="Loop" id="b00b5fe9e6688574" memberName="loopComp2" virtualName=""
             explicitFocusOrder="0" pos="64 80 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="c4cd829122448999" memberName="loopComp3" virtualName=""
             explicitFocusOrder="0" pos="120 80 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="9111df5ff3bc511e" memberName="loopComp4" virtualName=""
             explicitFocusOrder="0" pos="176 80 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="b8699b04b7bf815f" memberName="loopComp5" virtualName=""
             explicitFocusOrder="0" pos="8 136 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="dba69a4e114b83fb" memberName="loopComp6" virtualName=""
             explicitFocusOrder="0" pos="64 136 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="ec6ed9e2808589e7" memberName="loopComp7" virtualName=""
             explicitFocusOrder="0" pos="120 136 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="26531a4978bbf53e" memberName="loopComp8" virtualName=""
             explicitFocusOrder="0" pos="176 136 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="c47369e6c31aa80" memberName="loopComp9" virtualName=""
             explicitFocusOrder="0" pos="8 192 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="af1f8a49fd5d306a" memberName="loopComp10" virtualName=""
             explicitFocusOrder="0" pos="64 192 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="ebe3d89d1bc37e90" memberName="loopComp11" virtualName=""
             explicitFocusOrder="0" pos="120 192 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="95bdc00483bfba38" memberName="loopComp12" virtualName=""
             explicitFocusOrder="0" pos="176 192 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="cb6a5d32a9260f81" memberName="loopComp13" virtualName=""
             explicitFocusOrder="0" pos="8 248 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="6e9705768283505a" memberName="loopComp14" virtualName=""
             explicitFocusOrder="0" pos="64 248 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="d782135ea1600c58" memberName="loopComp15" virtualName=""
             explicitFocusOrder="0" pos="120 248 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <JUCERCOMP name="Loop" id="d77e356f10ba8107" memberName="loopComp16" virtualName=""
             explicitFocusOrder="0" pos="176 248 50 50" sourceFile="LoopComponent.cpp"
             constructorParams=""/>
  <GROUPCOMPONENT name="Loops" id="d849a56026ea126e" memberName="groupComponent"
